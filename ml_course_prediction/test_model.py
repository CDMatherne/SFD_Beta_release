...
Run this from the LLM-MLv1 directory or ml_course_prediction directory
"""
import torch
import sys
import os
...
ml_course_prediction_dir = script_dir.parent
...
# Change to project root directory for consistent imports
